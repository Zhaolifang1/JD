package com.example.jd.sort.bean;
...
public class SortRightBean {
    ...
    public static SortRightBean objectFromData(String str) {

        return new Gson().fromJson(str, SortRightBean.class);
    }
    ...
    public static class DataBean {
        ...
        public static class ListBean {
            ...
            public ListBean(String icon, String name, int pcid, int pscid) {
                this.icon = icon;
                this.name = name;
                this.pcid = pcid;
                this.pscid = pscid;
